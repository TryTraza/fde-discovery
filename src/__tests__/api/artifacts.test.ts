...
import { GET as listArtifacts, POST as uploadArtifact } from '@/app/api/clients/[id]/processes/[processId]/artifacts/route';
import { GET as getArtifact, DELETE as deleteArtifact } from '@/app/api/clients/[id]/processes/[processId]/artifacts/[artifactId]/route';
import { createArtifact, listArtifactsByProcess, getArtifactById, softDeleteArtifact } from '@/lib/db/queries/artifacts';
