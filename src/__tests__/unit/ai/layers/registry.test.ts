...
vi.mock('@/lib/db/queries/processes', () => ({ getProcessById: vi.fn(), getProcessWithModel: vi.fn() }));
vi.mock('@/lib/db/queries/sessions', () => ({ getSessionById: vi.fn(), listSessionContacts: vi.fn(), getCompletedSessionsByProcess: vi.fn() }));
