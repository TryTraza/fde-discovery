...
describe('Enum values', () => {
  ...
  it('processStatusEnum has correct values', () => {
    expect(schema.processStatusEnum.enumValues).toEqual([
  ...
  it('questionStatusEnum has correct values', () => {
    expect(schema.questionStatusEnum.enumValues).toEqual([
      'open', 'sent', 'resolved',
    ]);
  });

  it('snapshotTriggerEnum has correct values', () => {
    expect(schema.snapshotTriggerEnum.enumValues).toEqual([
