...
export async function PATCH(
  ...
  try {
    ...
    const merged = {
      ...
      description: parsed.data.description !== undefined ? parsed.data.description : (existing.description ?? null),
      ...
      schemaSlug: parsed.data.schemaSlug !== undefined ? parsed.data.schemaSlug : (existing.schemaSlug ?? null),
