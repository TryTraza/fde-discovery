...
const schemaRegistry: Record<string, SchemaRegistryEntry> = {
  ...
  'prep-brief': {
    ...
    label: 'Prep Brief',
    description:
      'Pre-session briefing with summary, questions, approaches, areas to probe, and watch-fors.',
  ...
  'session-synthesis': {
    ...
    description:
      'Post-session synthesis with process model changes, open questions, and confidence score.',
  ...
  'shadowing-synthesis': {
    ...
    description:
      'Post-shadowing synthesis with event analysis, system aggregation, and process model updates.',
    schema: synthesisOutputSchema,
  },
}
