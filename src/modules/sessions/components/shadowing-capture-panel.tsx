...
import { CaptureStatusBar } from '@/modules/capture/components/capture-status-bar'
import { EventTypeBar } from '@/modules/capture/components/event-type-bar'
import { ObservationInput } from '@/modules/capture/components/observation-input'
import { SystemPicker } from '@/modules/capture/components/system-picker'
import { SuggestionChips } from '@/modules/capture/components/suggestion-chips'
import { EventLogPanel } from '@/modules/capture/components/event-log-panel'
import { AnalyticsSidebar } from '@/modules/capture/components/analytics-sidebar'
import { ConfirmEndDialog } from '@/modules/capture/components/confirm-end-dialog'
